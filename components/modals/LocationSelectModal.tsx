...
import { View, StyleSheet, Text, SafeAreaView, TouchableOpacity, ScrollView, Image } from 'react-native';
...
const LocationSelectionModal = ({ locations, onSelect, onClose }: LocationSelectionModalProps) => {
        ...
        <View style={styles.container}>
            <SafeAreaView style={[elements.tray, { margin: 20, padding: 20, height: 400 }]}>
                <View style={[styles.headerContainer]}>
                    <Text style={[elements.mediumText, { flex: 1 }]}>Search Results: {locations.length}</Text>

...
function InformationTray({ title, titleBarColor, titleTextColor, editButton, onEditPress, count, children }: InformationTrayProps) {
  const titleColor = titleTextColor || colors.primaryText;
